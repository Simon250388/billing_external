...
Процедура СтабПериодыИзменитьТехническуюВозможностьУстановкиПУ(Ссылка, Параметры)
	...
	|	ХарактеристикиТочекУчета.Ссылка КАК Ссылка,
	|	ХарактеристикиТочекУчета.Дата КАК Дата
	|ПОМЕСТИТЬ ДанныеСтабильныхПериодов
	|ИЗ
	|	ХарактеристикиТочекУчета КАК ХарактеристикиТочекУчета
	...
	|		ПО ХарактеристикиТочекУчета.Организация = энргСтабильныеПериодыИзмерителиНаправлений.Организация
	|			И ХарактеристикиТочекУчета.ПериодНачисления = энргСтабильныеПериодыИзмерителиНаправлений.ПериодНачисления
	|			И ХарактеристикиТочекУчета.Район = энргСтабильныеПериодыИзмерителиНаправлений.Район
	|			И ХарактеристикиТочекУчета.ЧастныйСектор = энргСтабильныеПериодыИзмерителиНаправлений.ЧастныйСектор
	|			И ХарактеристикиТочекУчета.Строение = энргСтабильныеПериодыИзмерителиНаправлений.Строение
	|			И ХарактеристикиТочекУчета.Помещение = энргСтабильныеПериодыИзмерителиНаправлений.Помещение
	|			И ХарактеристикиТочекУчета.ТочкаУчета = энргСтабильныеПериодыИзмерителиНаправлений.ТочкаУчета
	...
	|	ДанныеСтабильныхПериодов.Дата КАК ДатаРегистратора,
	|	ДанныеСтабильныхПериодов.Ссылка КАК ДокРегистратор,
	...
	|			ДанныеСтабильныхПериодов.ТочкаУчета,
	|			ДанныеСтабильныхПериодов.Измеритель,
	|			ДанныеСтабильныхПериодов.ДокРегистратор) КАК ВложенныйЗапрос
	...
	|			И ДанныеСтабильныхПериодов.Измеритель = ВложенныйЗапрос.Измеритель
	|			И ДанныеСтабильныхПериодов.ДокРегистратор = ВложенныйЗапрос.ДокРегистратор";
