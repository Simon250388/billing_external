...
Функция ТекстЗапросаЗаключениеДоговора() 
	...
	|	бестЗаключениеДоговоровСЮридическимиЛицамиОбъектыРасчета.ОбъектРасчета.МКД КАК Строение,
	|	бестЗаключениеДоговоровСЮридическимиЛицамиОбъектыРасчета.ОбъектРасчета.Помещение КАК Помещение
	...
	|	ВложенныйЗапрос.ПриборУчета КАК ПриборУчета,
	|	ВложенныйЗапрос.ПриборВведен КАК ПриборВведен,
	|	ДанныеОбъектовРасчета.Строение КАК Строение,
...
Функция ТекстЗапросаПодключениеУслуги() 
	...
	|	ДанныеШапкиТочкиУчета.Строение КАК Строение
