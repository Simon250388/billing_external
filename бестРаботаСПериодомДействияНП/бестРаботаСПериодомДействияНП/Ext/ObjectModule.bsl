...
Функция ТекстЗапросаЗаключениеДоговора() 
	...
	|	бестЗаключениеДоговоровСЮридическимиЛицамиОбъектыРасчета.МКД.Этажность КАК МКДЭтажность
	...
	|		ПО бестЗаключениеДоговоровСЮридическимиЛицамиОбъектыРасчета.МКД = энргСтроенияВидыБлагоустройстваТарифныеКатегории.Ссылка
	|ГДЕ
	...
	|	ДанныеОбъектовРасчета.ГруппаПотребителей КАК ГруппаПотребителей,
	|	ВложенныйЗапрос.IDСтрокиВладельца КАК IDСтрокиВладельца,
	|	ЕСТЬNULL(ДанныеОбъектовРасчета.энргСтроенияВидБлагоустройстваИндивидуальный, ЗНАЧЕНИЕ(Справочник.энргВидыБлагоустройств.ПустаяСсылка)) КАК ВидБлагоустройства,
	|	ДанныеОбъектовРасчета.энргСтроенияТарифнаяКатегория КАК энргСтроенияТарифнаяКатегория,
	...
	|			И (ВЫБОР
	|				КОГДА ДанныеОбъектовРасчета.энргСтроенияУслуга ЕСТЬ NULL
	|					ТОГДА ИСТИНА
	|				ИНАЧЕ ДанныеОбъектовРасчета.энргСтроенияУслуга = ВложенныйЗапрос.Услуга
	|			КОНЕЦ)
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	...
	|	ДанныеТочекУчета.ВидБлагоустройства КАК ВидБлагоустройства,
	|	ДанныеТочекУчета.Поставщик КАК Поставщик
	|ПОМЕСТИТЬ Услуги
	|ИЗ
	...
	|	Услуги.ВидБлагоустройства КАК ВидБлагоустройства,
