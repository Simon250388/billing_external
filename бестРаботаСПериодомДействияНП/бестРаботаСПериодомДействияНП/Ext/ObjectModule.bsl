...
Функция ТекстЗапросаЗаключениеДоговора() 
	...
	|		ЕСТЬNULL(бестЗаключениеДоговоровСЮридическимиЛицамиШкалыПриборовУчета.Шкала, ЗНАЧЕНИЕ(Справочник.энргШкалыПриборовУчета.ПустаяСсылка)) КАК Шкала,
	|		ВЫБОР
	...
	|			ЛЕВОЕ СОЕДИНЕНИЕ Документ.бестЗаключениеДоговоровСЮридическимиЛицами.ШкалыПриборовУчета КАК бестЗаключениеДоговоровСЮридическимиЛицамиШкалыПриборовУчета
	|			ПО УслугиСпособРасчетаНорматива.IDСтроки = бестЗаключениеДоговоровСЮридическимиЛицамиШкалыПриборовУчета.IDСтрокиТочкиУчета
	|				И (бестЗаключениеДоговоровСЮридическимиЛицамиШкалыПриборовУчета.Ссылка = &Ссылка)) КАК ВложенныйЗапрос
...
Функция ТекстЗапросаПриборыУзловУчета() 
	...
	|			И (бестЗаключениеДоговоровСЮридическимиЛицами.ОбъектыРасчета.Ссылка = &Ссылка)
	|ГДЕ
	|	бестЗаключениеДоговоровСЮридическимиЛицами.Ссылка = &Ссылка
	|	И НЕ ТаблицаТочкиУчета.ПриборУчета = ЗНАЧЕНИЕ(Справочник.энргПриборыУчетаАбонента.ПустаяСсылка)
	|
...
Функция ТекстЗапросаПодключениеУслуги() 
	...
	|	бестОбъектыРасчета.МКД.Этажность КАК КоличествоЭтажей,
