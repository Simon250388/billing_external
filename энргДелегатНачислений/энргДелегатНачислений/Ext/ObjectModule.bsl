...
Процедура ДобавитьНаборВСхему(Схема,ИмяНабора,ТаблицаДляПомещения)
	...
	ИначеЕсли ИмяНабора  = "ЗначенияДополнительныхСоциальныхНормативов" Тогда
		...
		РегистрыСведений.энргЗначенияДополнительныхСоциальныхНормативов.ЗначенияТекущихДополнительныхСоциальныхНормПотребления(Схема,Параметры,ТаблицаДляПомещения);
