...
Перем МВТ, ИзменяемыеПараметрыПоТипам, ПоляПорядка, ИзмеренияИсключая, ТаблицыДанных, ТаблицыИзмененияПлощади, ТаблицыИзмененияШкал;
...
Функция ДанныеДокументов() Экспорт
...
Функция ДанныеИзмененияСоставаШкал() Экспорт 
...
Функция ДанныеДокументовИзмененияПлощади() Экспорт 
