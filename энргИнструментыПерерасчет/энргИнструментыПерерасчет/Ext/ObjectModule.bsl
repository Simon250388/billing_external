...
Текст  =
	...
	|		ИНАЧЕ ДОБАВИТЬКДАТЕ(ДОБАВИТЬКДАТЕ(НастройкиВыполненияГодовойКорректировки.НачалоПериода, ГОД, -ГОД(НастройкиВыполненияГодовойКорректировки.НачалоПериода)), ГОД, ГОД(ДОБАВИТЬКДАТЕ(&НачалоГода, ГОД, -1)))
	...
	|		ИНАЧЕ КОНЕЦПЕРИОДА(ДОБАВИТЬКДАТЕ(ДОБАВИТЬКДАТЕ(НастройкиВыполненияГодовойКорректировки.КонецПериода, ГОД, -ГОД(НастройкиВыполненияГодовойКорректировки.КонецПериода)), ГОД, ГОД(ДОБАВИТЬКДАТЕ(&НачалоГода, ГОД, -1))), ДЕНЬ)
	...
	|	ЕСТЬNULL(НастройкиВыполненияГодовойКорректировкиМКД.НачалоПериода, ЕСТЬNULL(НастройкиВыполненияГодовойКорректировкиРайон.НачалоПериода, ДОБАВИТЬКДАТЕ(&НачалоГода, ГОД, -1))),
	|	ЕСТЬNULL(НастройкиВыполненияГодовойКорректировкиМКД.КонецПериода, ЕСТЬNULL(НастройкиВыполненияГодовойКорректировкиРайон.КонецПериода, КОНЕЦПЕРИОДА(ДОБАВИТЬКДАТЕ(&НачалоГода, ГОД, -1), ГОД)))
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|					И (энргОбъемНачислений.Период <= КОНЕЦПЕРИОДА(ТочкиДляКорректировки.КонецПериода, ДЕНЬ))
