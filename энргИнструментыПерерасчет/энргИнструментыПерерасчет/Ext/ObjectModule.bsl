...
Процедура СнятьСредниеНачисления(Организация,ПериодНачисления,Район,ЧастныйСектор,Строение,Помещение,Документ) Экспорт
	...
	Пока Выборка.следующий() цикл
		...
		СтрокаНабора.ОбъемУслугиПотери 				= -Выборка.ОбъемУслугиПотери;
		СтрокаНабора.ОбъемУслугиПотребленныйПотери 	= -Выборка.ОбъемУслугиПотребленныйПотери;
...
Процедура ПрочитатьНеСписанныйСредний(МВТ,ПериодНачисления,Организация,Район,ЧастныйСектор,Строение,Помещение,НачалоПериодаРасчета,ТаблицаПриемник = Неопределено)
	...
	|	энргНачисленныйСреднийОбъемОстатки.ЗначениеТарифаРЭК КАК ЗначениеТарифаРЭК,
...
Функция РезультатЗапросаПерерасчетСреднего(МВТ,Организация,ПериодНачисления,КонецПериодаРасчета,Район,ЧастныйСектор,Строение,Помещение,НачисленныйСреднийОбъем=Неопределено)
	...
	Если НачисленныйСреднийОбъем <> Неопределено тогда
		...
		|	НеСписанныйСредний.ЗначениеТарифаРЭК,
		...
		|	НеСписанныйСреднийБезГруппировки.ЗначениеТарифаРЭК,
		...
		|	СУММА(НеСписанныйСреднийБезГруппировки.ОбъемУслугиПотери) КАК ОбъемУслугиПотери,
		|	СУММА(НеСписанныйСреднийБезГруппировки.ОбъемУслугиПотребленныйПотери) КАК ОбъемУслугиПотребленныйПотери,
	...
	|	НеСписанныйСредний.ЗначениеТарифаРЭК КАК ЗначениеТарифаРЭК,
	...
	|	ДанныеДляСписанияМинДата.ЗначениеТарифаРЭК КАК ЗначениеТарифаРЭК,
	...
	|	ДанныеДляСписанияМинДата.ОбъемУслугиПотери КАК ОбъемУслугиПотери,
	|	ДанныеДляСписанияМинДата.ОбъемУслугиПотребленныйПотери КАК ОбъемУслугиПотребленныйПотери,
	...
	|	ДанныеДляСписанияМинДата.ЗначениеТарифаРЭК,
	...
	|	ДанныеДляСписанияМинДата.ОбъемУслугиПотери,
	|	ДанныеДляСписанияМинДата.ОбъемУслугиПотребленныйПотери,
	...
	|	ВложенныйЗапрос.ЗначениеТарифаРЭК КАК ЗначениеТарифаРЭК,
	...
	|		ДанныеДляСписанияМинРегистратор.ЗначениеТарифаРЭК КАК ЗначениеТарифаРЭК,
	...
	|		ДанныеДляСписанияМинРегистратор.ОбъемУслугиПотери КАК ОбъемУслугиПотери,
	|		ДанныеДляСписанияМинРегистратор.ОбъемУслугиПотребленныйПотери КАК ОбъемУслугиПотребленныйПотери,
