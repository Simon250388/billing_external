...
Функция ТекстЗапросаВспомогательныеДанныеНачисления(ОтборПоДоговору,Отдельностоящие)
	...
	|	бестСтабильныеПериодыШкалыНП.УзелУчета КАК УзелУчета,
	...
	|	бестНомераСтрокСтабильногоПериодаНП.УзелУчета КАК УзелУчета,
	...
	|	бестНомераСтрокСтабильногоПериодаНП.УзелУчета,
	...
	|			И СтабильныеПериодыНачало.УзелУчета = СтабильныеПериодыШкалы.УзелУчета
...
Функция ТекстПолучитьСтабильныеПериоды(ЭтоПерерасче,Отдельностоящие)  
	...
	|	НомераСтрокНачалоСезонности.УзелУчета КАК УзелУчета,
	...
	|			И НомераСтрокНачалоСезонности.УзелУчета = СтабильныеПериодыНачало.УзелУчета
	...
	|	НомераСтрокКонецСезонности.УзелУчета КАК УзелУчета,
	...
	|			И НомераСтрокКонецСезонности.УзелУчета = СтабильныеПериодыНачало.УзелУчета
	...
	|			И СтабильныеПериодыНачалоСезонности.УзелУчета = НомераСтрокНачалоСезонностиБезФормулы.УзелУчета
	...
	|			И СтабильныеПериодыСезонность.УзелУчета = НомераСтрокКонецСезонностиБезФормулы.УзелУчета
	...
	|			И СтабильныеПериодыПоказанияНачало.УзелУчета = СтабильныеПериодыПоказанияКонец.УзелУчета
