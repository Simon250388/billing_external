...
Функция ТекстЗапросаВспомогательныеДанныеНачисления(ИсключаяОтдельностоящие, МКД, Договор)
	...
	Иначе
		...
		ОтборОбъектРасчета											= " И ОбъектРасчета В (ВЫБРАТЬ ДоговорыОбъектовРасчета.ОбъектРасчета КАК ОбъектРасчета ИЗ ДоговорыОбъектовРасчета КАК ДоговорыОбъектовРасчета)";
	...
	|			&КонецПериодаРасчета,
	|			Организация = &Организация
	|				И Район = &Район" + ОтборОбъектРасчета + "
