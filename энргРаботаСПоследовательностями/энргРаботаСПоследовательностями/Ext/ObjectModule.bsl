...
Процедура СторнироватьАвансыИОплату(ПараметрыОперации, ДанныеДокумента, ДанныеНачислений)	
	...
	//|ПОМЕСТИТЬ ВТ_НастройкаПерерасчета
	//|ИЗ
	//|	РегистрСведений.энргСпособыРаспределенияОплаты.СрезПоследних(&ПериодНачисления, Организация = &Организация) КАК энргСпособыРаспределенияОплатыСрезПоследних
	//|;
	//|
	//|////////////////////////////////////////////////////////////////////////////////
	//|ВЫБРАТЬ
	...
	//|	ВЫБОР
	//|		КОГДА ВТ_НастройкаПерерасчета.ПерерасчетыВключатьВРасчетныйПериод
	//|			ТОГДА &ПериодНачисления
	//|		ИНАЧЕ энргАвансыИспользованные.ПериодРасчета
	...
	//|	ВТ_НастройкаПерерасчета КАК ВТ_НастройкаПерерасчета
	//|ГДЕ
	//|	энргПерерасчетКорректировкаОплаты.Ссылка = &Ссылка
...
Функция ПровестиВзаиморасчеты(ПараметрыПроведения,МассивДокументовНачисления)
	...
	|СпособРаспределенияОплаты, НастройкиПорядкаПогашения, ОтрицательныеНачисленияСоздаютАвансы",
	Организация, ПериодНачисления,район,
	ПараметрыПроведения.Авансы,ПараметрыПроведения.СуммаАванса,ДанныеЗадолженности,
	СпособРаспределенияОплаты,ПараметрыПроведения.НастройкиПорядкаПогашения,ПараметрыПроведения.ОтрицательныеНачисленияСоздаютАвансы);
...
Функция РезультатДанныеНачислений(МВТ)
	...
	|			ТОГДА ВложенныйЗапрос.ПериодНачисления
	|		ИНАЧЕ ВложенныйЗапрос.ПериодРасчета
