...
Функция СтабильныеПериодыВводНачальныхОстатков(Строение, Помещение)
	...
	|	ВсеПараметрыРасчетаБезФормул.ТочкаУчета КАК ЗависимаяТочкаУчета,
	...
	|			ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.энргКлючиПомещений КАК энргКлючиПомещений
	|			ПО энргВводНачальныхОстатковФормулыРасчета.КлючПомещения = энргКлючиПомещений.КлючПомещения
	|		ПО ВсеПараметрыРасчетаБезФормул.IDСтрокиТочкиУчета = энргВводНачальныхОстатковФормулыРасчета.IDСтрокиТочкиУчета
	...
	|		ПО ВсеПараметрыРасчетаБезФормул.IDСтрокиТочкиУчета = ТочкиПоФормулам.IDСтрокиТочкиУчета
	|			И ВсеПараметрыРасчетаБезФормул.ДокРегистратор = ТочкиПоФормулам.ДокРегистратор
