...
Процедура УменьшитьПоступившиеАвансы(ПараметрыОперации, ДанныеДокумента, ДанныеНачислений)	
	...
	ЗаписьАвансыПоступившие.Сумма 				= ?(ДанныеНачислений.СуммаНачислений >= ПараметрыОперации.СуммаАванса, -ПараметрыОперации.СуммаАванса, ДанныеНачислений.СуммаНачислений - ПараметрыОперации.СуммаАванса);
	...
	ПараметрыОперации.СуммаАванса 				= ДанныеНачислений.СуммаНачислений - ЗаписьАвансыПоступившие.Сумма;
КонецПроцедуры
...
Процедура УвеличитьЗадолженность(ПараметрыОперации, ДанныеДокумента, ДанныеНачислений)
	...
	Если ПараметрыОперации.СуммаАванса > 0 тогда
		Если ДанныеДокумента.ПерерасчетКорректировкаОплаты Тогда
			УменьшитьПоступившиеАвансы(ПараметрыОперации, ДанныеДокумента,ДанныеНачислений);
		Иначе
