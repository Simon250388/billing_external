...
Функция СтабильныеПериодыВводНачальныхОстатков(Строение, Помещение)
	...
	|	ВсеПараметрыРасчетаСИзмерителями.НаправлениеИспользованияТУ КАК НаправлениеИспользованияТУ,
	...
	|		И (ВсеПараметрыРасчета.ВидБлагоустройства = КлючиНорматива.ВидБлагоустройства)
	|		И (КлючиНорматива.Измеритель = ЗНАЧЕНИЕ(Справочник.энргНаправлениеИспользованияТочекУчета.ОсновноеНаправление))
	|;
	|  
	|////////////////////////////////////////////////////////////////////////////////
	|УНИЧТОЖИТЬ ЗначенияРазрезов
	|;
	|////////////////////////////////////////////////////////////////////////////////
	|УНИЧТОЖИТЬ КлючиНорматива 
	|;
	| 
	|";
	...
	//|		И (ВсеПараметрыРасчетаСИзмерителями.ВидБлагоустройства = КлючиНорматива.ВидБлагоустройства)
	|		И (КлючиНорматива.Измеритель = ВсеПараметрыРасчетаСИзмерителями.Измеритель)";
