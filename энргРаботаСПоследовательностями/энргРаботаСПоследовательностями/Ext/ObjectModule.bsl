		...
		Если НЕ РезультатДокументыДляПроведения.Пустой() Тогда
			...
			ВыборкаДокументыДляПроведения 											= РезультатДокументыДляПроведения.Выбрать();
			 ...
			 Пока ВыборкаДокументыДляПроведения.Следующий() Цикл
				 ...
				 НаборСтабильныеПериодыИзмерителиНаправлений.Отбор.Организация 		= ВыборкаДокументыДляПроведения.Организация;
				 НаборСтабильныеПериодыИзмерителиНаправлений.Отбор.ПериодНачисления = ПериодНачисления;
				 НаборСтабильныеПериодыИзмерителиНаправлений.Отбор.Район 			= ВыборкаДокументыДляПроведения.Район;
				 НаборСтабильныеПериодыИзмерителиНаправлений.Отбор.ЧастныйСектор 	= ВыборкаДокументыДляПроведения.ЧастныйСектор;
				 Если Не ВыборкаДокументыДляПроведения.ЧастныйСектор Тогда
					 НаборСтабильныеПериодыИзмерителиНаправлений.Отбор.Строение 	= ВыборкаДокументыДляПроведения.Строение;
				 КонецЕсли;
				 НаборСтабильныеПериодыИзмерителиНаправлений.Отбор.ДокРегистратор 	= ВыборкаДокументыДляПроведения.ДокРегистратор;				 
				 
				 НаборНомерСтрокСтабПериода 										= РегистрыСведений.энргНомераСтрокСтабильногоПериода.СоздатьНаборЗаписей();
				 НаборНомерСтрокСтабПериода.Отбор.Организация 						= ВыборкаДокументыДляПроведения.Организация;
				 НаборНомерСтрокСтабПериода.Отбор.ПериодНачисления 					= ПериодНачисления;
				 НаборНомерСтрокСтабПериода.Отбор.Район 							= ВыборкаДокументыДляПроведения.Район;
				 НаборНомерСтрокСтабПериода.Отбор.ЧастныйСектор 					= ВыборкаДокументыДляПроведения.ЧастныйСектор;
				 Если Не ВыборкаДокументыДляПроведения.ЧастныйСектор Тогда
					 НаборНомерСтрокСтабПериода.Отбор.Строение 						= ВыборкаДокументыДляПроведения.Строение;
				 КонецЕсли;
				 НаборНомерСтрокСтабПериода.Отбор.ДокРегистратор 					= ВыборкаДокументыДляПроведения.ДокРегистратор; 			 
				 
				 НаборМаксимальныеПоказания 										= РегистрыСведений.энргМаксимальныеПоказанияСрез.СоздатьНаборЗаписей(); 
				 НаборМаксимальныеПоказания.Отбор.Организация 						= ВыборкаДокументыДляПроведения.Организация;
				 НаборМаксимальныеПоказания.Отбор.ПериодНачисления 					= ПериодНачисления;
				 НаборМаксимальныеПоказания.Отбор.Район 							= ВыборкаДокументыДляПроведения.Район;
				 НаборМаксимальныеПоказания.Отбор.ЧастныйСектор 					= ВыборкаДокументыДляПроведения.ЧастныйСектор;
				 Если Не ВыборкаДокументыДляПроведения.ЧастныйСектор Тогда
					 НаборМаксимальныеПоказания.Отбор.Строение 						= ВыборкаДокументыДляПроведения.Строение;
				 КонецЕсли;
