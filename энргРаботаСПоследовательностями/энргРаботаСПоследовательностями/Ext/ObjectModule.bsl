...
Процедура ВосстановитьПоследовательностьВзаиморасчеты(Организация, ПериодНачисления,Район,МКД=Неопределено,Абонент=Неопределено) Экспорт 
	...
	ПерерасчетыВключатьВРасчетныйПериод							= ДанныеСреза.ПерерасчетыВключатьВРасчетныйПериод;
	...
	ПараметрыПроведения.Вставить("ПерерасчетыВключатьВРасчетныйПериод",		ПерерасчетыВключатьВРасчетныйПериод);
...
Функция ПровестиВзаиморасчеты(ПараметрыПроведения,МассивДокументовНачисления)
	...
	ПерерасчетыВключатьВРасчетныйПериод			= ПараметрыПроведения.ПерерасчетыВключатьВРасчетныйПериод;
	Исключен  									= Перечисления.энргСостояниеДокументаВПоследовательности.ИсключенИзПоследовательности;
	ПроведенВПоследоватености  					= Перечисления.энргСостояниеДокументаВПоследовательности.ПроведенВПоследовательности;
	...
	|СпособРаспределенияОплаты, ПерерасчетыВключатьВРасчетныйПериод, НастройкиПорядкаПогашения, ОтрицательныеНачисленияСоздаютАвансы",
	Организация, ПериодНачисления,район,
	ПараметрыПроведения.Авансы,ПараметрыПроведения.СуммаАванса,ДанныеЗадолженности,
	СпособРаспределенияОплаты,ПерерасчетыВключатьВРасчетныйПериод,ПараметрыПроведения.НастройкиПорядкаПогашения,ПараметрыПроведения.ОтрицательныеНачисленияСоздаютАвансы);
...
Функция РезультатОплата(МВТ, НачалоПериодаРасчета)
	...
	|	КорректировкаОплаты.СуммаСтало
	|ИЗ
	|	ДокументыДляПроведения КАК ДокументыДляПроведения
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.энргПерерасчет.КорректировкаОплаты КАК КорректировкаОплаты
	|		ПО ДокументыДляПроведения.ДокРегистратор = КорректировкаОплаты.Ссылка
