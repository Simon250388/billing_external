...
Процедура ЗаполнитьСвойстваПараметрыПроведенияПоследовательностиВзаиморасчетов(ПараметрыПроведения, ТекАбонент, КоллекцияВыборок, КоллекцияПустыхРезультатов, ДопПараметры)
	...
	ДанныеНачисленийПени						= ДанныеНачислений(ТекАбонент, КоллекцияВыборок.ВыборкаДанныеНачисленийПени);
	...
	ДанныеЗадолженностиПени 					= ЗадолженностьНаГраницу(ТекАбонент, КоллекцияВыборок.ВыборкаЗадолженностьПени);
...
Процедура УвеличитьЗадолженностьПени(ПараметрыОперации, ДанныеДокумента, ДанныеНачисленийПени)
	ДанныеНачислений = ДанныеНачисленийПени;
...
Функция ТекстДанныеНачисленийПени()
	...
	|			КОГДА ЕСТЬNULL(СпособРаспределенияОплаты.ПерерасчетыВключатьВРасчетныйПериод, ЛОЖЬ)
	|				ТОГДА ДокументыДляПроведения.ПериодНачисления
	|			ИНАЧЕ энргНачислениеПени.ПериодНачисления
	|		КОНЕЦ КАК ПериодРасчета,
