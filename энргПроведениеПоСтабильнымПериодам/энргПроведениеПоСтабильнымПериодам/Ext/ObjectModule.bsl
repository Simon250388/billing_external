...
Процедура ВосстановитьПоследовательность(яСервисСтабильныеПериоды,Ошибки) Экспорт  	
	...
	НаборыДанных.Вставить("ИзменяемыеПараметрыПоТипам", 		СервисСтабильныеПериоды.ИзменяемыеПараметрыПоТипам(МВТ));
...
Процедура УстановитьЗначениеПлощади(Параметры, Ресурсы, Услуга)
	...
	ЗначенияПараметровПоУслуге 			= Параметры.ЗначенияПараметровПоНаправлениямУслуг[Услуга];
