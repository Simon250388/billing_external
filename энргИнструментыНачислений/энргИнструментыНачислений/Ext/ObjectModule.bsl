...
Функция ТекстПолучитьДанныеДляРасчета()
	...
	|	ВЫБОР
	|		КОГДА энргПомещения.Ссылка ЕСТЬ NULL
...
Функция ТекстРассчитатьИндивидуальныйОбъемПотребления()
	...
	|	(ОбъемыНачислений.ОбъемУслуги - ОбъемыНачислений.ОбъемУслугиСоцНорма) * ОбъемыНачислений.ЗначениеТарифаСверхНорматива * ОбъемыНачислений.ПовыщающийКоэффициент,
