...
Процедура РаспредениеОбъемаМКД_УК(Организация,ПериодНачисления, Район,МКД, Документ,СтруктураМКД_УК)  Экспорт 
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |ИЗ
	               |	СменаУК_Конец КАК СменаУК_Конец
	               ...
	               |		ПО (бестДоговорыТочекУчетаСрезПоследних.Договор.Контрагент = СменаУК_Конец.УК)
	               |			И (бестДоговорыТочекУчетаСрезПоследних.ОбъектРасчета.МКД = СменаУК_Конец.МКД)
	               |;
	               |
	               |////////////////////////////////////////////////////////////////////////////////
	               |ВЫБРАТЬ
