...
Процедура РаспредениеОбъемаМКД_УК(Организация,ПериодНачисления, Район,МКД, Документ,СтруктураМКД_УК)  Экспорт 
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |////////////////////////////////////////////////////////////////////////////////
	               |ВЫБРАТЬ РАЗЛИЧНЫЕ
	               |	бестВладельцыОбъектовРасчетаСрезПоследних.ОбъектРасчета КАК ОбъектРасчета,
	               |	бестВладельцыОбъектовРасчетаСрезПоследних.Договор КАК Договор
	               |ПОМЕСТИТЬ ДоговорыОбъектов
	               |ИЗ
	               ...
	               |		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.бестВладельцыОбъектовРасчета.СрезПоследних(
	               |				&КонецПериода,
	               |				Организация = &Организация
	               |					И Район = &Район
	               |					И (Договор.Контрагент, ОбъектРасчета.МКД) В
	               |						(ВЫБРАТЬ РАЗЛИЧНЫЕ
	               |							СменаУК_Конец.УК КАК УК,
	               |							СменаУК_Конец.МКД КАК МКД
	               |						ИЗ
	               |							СменаУК_Конец КАК СменаУК_Конец)) КАК бестВладельцыОбъектовРасчетаСрезПоследних
	               |		ПО бестСостояниеДоговоровСрезПоследних.Договор = бестВладельцыОбъектовРасчетаСрезПоследних.Договор
	               |			И бестСостояниеДоговоровСрезПоследних.Организация = бестВладельцыОбъектовРасчетаСрезПоследних.Организация
	               |			И бестСостояниеДоговоровСрезПоследних.Район = бестВладельцыОбъектовРасчетаСрезПоследних.Район
	               |ГДЕ
	               ...
	               |	ДоговорыОбъектов.Договор КАК Договор,
	               ...
	               |		ПО бестАктивностьТочекУчетаНПСрезПоследних.ОбъектРасчета.МКД = СменаУК_Конец.МКД
	               |		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ДоговорыОбъектов КАК ДоговорыОбъектов
	               |		ПО бестАктивностьТочекУчетаНПСрезПоследних.ОбъектРасчета = ДоговорыОбъектов.ОбъектРасчета
	               |;
	               |
	               |////////////////////////////////////////////////////////////////////////////////
	               |ВЫБРАТЬ
