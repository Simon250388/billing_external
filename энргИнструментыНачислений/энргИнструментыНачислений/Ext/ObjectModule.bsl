			...
			Для Каждого КлючЗначениеТарифнаяЗона Из КлючЗначениеУслуга.Значение Цикл
				Для Каждого КлючЗначениеНачалоПериода Из КлючЗначениеТарифнаяЗона.Значение Цикл
					Для Каждого КлючЗначениеСоставнаяУслуга Из КлючЗначениеНачалоПериода.Значение Цикл
						...
						РаспредеделитьОбъемПомещенияПоУслугеНаПотомков(Набор, ЗначениеСтруктуры, ПараметрыРаспределенияОбъемаПомещения,КлючЗначениеУслуга.Ключ, КлючЗначениеТарифнаяЗона.Ключ, КлючЗначениеНачалоПериода.Ключ, КлючЗначениеСоставнаяУслуга.Ключ, ПомещенияСОстаткомРаспределения);
...
Процедура ИзменитьОстатокОбъемаКРаспределениюВПомещении(ДанныеВыборки, НачисленияПоУслугамПомещения) 
	...
	НачисленияПоУслугамПомещения[ДанныеВыборки.Услуга][ДанныеВыборки.ТарифнаяЗона][ДанныеВыборки.НачалоПериода][ДанныеВыборки.СоставнаяУслуга].ОбъемУслугиОстаток = НачисленияПоУслугамПомещения[ДанныеВыборки.Услуга][ДанныеВыборки.ТарифнаяЗона][ДанныеВыборки.НачалоПериода][ДанныеВыборки.СоставнаяУслуга].ОбъемУслугиОстаток - ДанныеВыборки.ОбъемУслуги;
	НачисленияПоУслугамПомещения[ДанныеВыборки.Услуга][ДанныеВыборки.ТарифнаяЗона][ДанныеВыборки.НачалоПериода][ДанныеВыборки.СоставнаяУслуга].ОбъемУслугиПотребленныйОстаток = НачисленияПоУслугамПомещения[ДанныеВыборки.ДанныеВыборки][ДанныеВыборки.ТарифнаяЗона][ДанныеВыборки.НачалоПериода][ДанныеВыборки.СоставнаяУслуга].ОбъемУслугиПотребленныйОстаток - ДанныеВыборки.ОбъемУслугиПотребленный;
		
КонецПроцедуры

Процедура РаспредеделитьОбъемПомещенияПоУслугеНаПотомков(Набор, ДанныеДляРаспределения, ПараметрыРаспределенияОбъемаПомещения, Услуга, ТарифнаяЗона, НачалоПериода, СоставнаяУслуга, ПомещенияСОстаткомРаспределения)
