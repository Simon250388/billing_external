...
Процедура РаспредениеОбъемаМКД_УК(Организация,ПериодНачисления, Район,МКД, Документ,СтруктураМКД_УК)  Экспорт 
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |	ОбъектыРасчетаТУ.ОбъектРасчета.МКД КАК МКД,
	               ...
	               |	ОбъектыРасчетаТУ.ОбъектРасчета.МКД,
	               ...
	               |		ПО бестОбъемНачисленийНП.МКД = ОбъектыРасчета.МКД
	               ...
	               |		ПО ОбъектыРасчета.МКД = бестНачислениеНП.МКД
...
Функция ТекстЗапросаДанныеДляРаспределения(Строение)
	...
	|	АбонентыРазделенныеЛицевыеСчета.ДопСоциальнаяНормаПотребления КАК ДопСоциальнаяНормаПотребления
	|ИЗ
	|	(ВЫБРАТЬ РАЗЛИЧНЫЕ
	|		ОсновнаяВыборка.Организация КАК Организация,
	|		ОсновнаяВыборка.ПериодНачисления КАК ПериодНачисления,
