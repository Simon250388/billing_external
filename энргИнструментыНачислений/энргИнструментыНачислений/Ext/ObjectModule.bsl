...
Процедура СкорректироватьПотреблениеСезонныхУслугМКД(Организация, ПериодНачисления,Район,Строение,Набор) Экспорт 
	...
	ЗаписатьНаборыЗаписейНачислениеМКД(ДокументОбъект, ЗамещатьНаборВыполненные, ТекЗавершениеОП, Набор, НаборВыполненные, Организация, Ошибки, ПериодНачисления, Район);
...
Процедура ЗаписатьНаборыЗаписейНачислениеМКД(ДокументОбъект, ЗамещатьНаборВыполненные, КонецПериодаРасчета, Набор, НаборВыполненные, Организация, Ошибки, ПериодНачисления, Район)
