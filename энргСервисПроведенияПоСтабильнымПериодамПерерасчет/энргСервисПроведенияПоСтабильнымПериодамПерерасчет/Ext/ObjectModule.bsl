...
Функция СостояниеНаГраницу(МВТ) Экспорт	
	Возврат ПолучитьДанныеВременнойТаблицы(МВТ,"СостояниеНаНачалоПериодаНачисления",ПоляПорядка);
КонецФункции

Функция СостояниеНаГраницуШкалы(МВТ) Экспорт
	Возврат ПолучитьДанныеВременнойТаблицы(МВТ,"СостояниеНаНачалоПериодаНачисления" + "Шкалы",ПоляПорядка); 
КонецФункции

Функция СостояниеНаГраницуИзмерители(МВТ) Экспорт  
	Возврат ПолучитьДанныеВременнойТаблицы(МВТ,"СостояниеНаНачалоПериодаНачисления" + "ИзмерителиНаправлений",ПоляПорядка);
КонецФункции
